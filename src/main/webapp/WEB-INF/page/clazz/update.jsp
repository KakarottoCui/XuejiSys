        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="clazzName" lay-verify="required" class="layui-input" value="${clazz.clazzName}">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="remark" class="layui-input" value="${clazz.remark}">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
