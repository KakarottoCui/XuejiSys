        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="subjectName" lay-verify="required" class="layui-input" value="${subject.subjectName}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">所属院系</label>
                <div class="layui-input-block">
                    <input type="text" name="college" lay-verify="required" class="layui-input" value="${subject.college}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">备注</label>
                <div class="layui-input-block">
                    <input type="text" name="remark" class="layui-input" value="${subject.remark}">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
